...
def send_report():
    ...
    client = boto3.client('ses', region_name='ap-southeast-1') #Choose which region you want to use SES
...
td {
  background: #ffea97;
    ...
    for region in region_list:
        append('<h1 style="color:red"><center> Region : '+region+' accountId :' +owner_id+'</center></h1>')
